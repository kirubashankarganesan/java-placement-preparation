SOLID Principles
SOLID is an acronym for five design principles that help in creating more maintainable, flexible, and scalable software. These principles were introduced by Robert C. Martin.
